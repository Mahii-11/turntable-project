        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-lg max-w-2xl text-gray-300">
              Expert turntable repair, restoration, and upgrade services to keep
              your vinyl sounding its best.
            </p>
          </motion.div>
        </div>
        <motion.div
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            >
              ...
              <p className="text-gray-300 mb-4">
                ...
                servicing of vintage turntables and audio equipment. Our expert
                technicians combine modern technical knowledge with a deep
                appreciation for classic audio engineering to deliver
                exceptional results.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <Card className="bg-[#2A2A2A] shadow-lg border-0 h-full">
                ...
                <CardContent>
                  <p className="text-gray-300">
                    Enhance your listening experience with our premium selection
                    of accessories and performance upgrades, carefully chosen to
                    complement your equipment.
                  </p>
                </CardContent>
              </Card>
            </motion.div>
          ...
          <div className="max-w-3xl mx-auto bg-[#2A2A2A] rounded-lg shadow-md p-8 border border-gray-700">
            ...
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-start">
                ...
                <span>
                  <strong className="text-[#D4AF37]">90-day warranty</strong> on
                  all repair work and parts
                </span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="h-5 w-5 text-[#D4AF37] mr-2 mt-1 flex-shrink-0" />
            ...
            <p className="text-gray-300 mt-4">
              ...
              equipment will continue to perform beautifully for years to come.
            </p>
          </div>
        </div>
      </section>
