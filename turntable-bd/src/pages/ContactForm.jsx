    ...
    <div className="bg-zinc-900 text-white min-h-screen flex flex-col items-center py-10 -mt-8">
      ...
      >
        ...
        <p className="text-center text-sm text-gray-400 mb-6">
          Do you need your turntable or audio equipment repaired? Please contact
          the shop through this page or give us a phone call for us to assess
          the situation.
          <br />
          We would be happy to answer any gear-related and equipment repair and
          purchasing questions through our email inquiry box or phone number.
