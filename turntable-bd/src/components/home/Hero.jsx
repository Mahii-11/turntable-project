    ...
    <section id="hero" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Premium turntables crafted for audiophiles who appreciate the warmth and richness of vinyl records
          </motion.p>
      ...
      >
        <a href="#showcase" className="flex flex-col items-center text-white hover:text-[#D4AF37] transition duration-300">
