    ...
    <section id="showcase" className="py-20 md:py-32 bg-black">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          >
            Discover our handcrafted turntables that deliver exceptional sound quality and timeless elegance.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="relative group transition duration-500 ease-in-out">
            <div className="relative">
              <img 
                src="https://images.unsplash.com/photo-1593078165899-c7d2ac0d6aea?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" 
          ...
          >
            <h3 className="font-serif text-3xl text-[#D4AF37] font-semibold mb-6">Maestro Pro T-1</h3>
            <p className="text-gray-300 mb-8">
              A masterpiece of engineering, the Maestro Pro T-1 delivers unparalleled sound quality with its precision-engineered components and innovative design. Experience vinyl as the artists intended.
            </p>
            ...
            <a href="#" className="inline-flex items-center font-medium text-[#D4AF37] hover:underline">
              View Specifications
